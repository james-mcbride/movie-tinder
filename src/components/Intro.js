...
const Intro = (props) => {
                    ...
                    <div className='nine wide column'>
                        <div className='introMovie'>
                            <div className="introPoster">
                                <img src={props.groupInfo.topMovie[0].poster} />
                                <div className='introTitle'>
                                    Your group, {props.groupInfo.groupName}'s top movie: <br />
                                    <strong>{props.groupInfo.topMovie[0].title}</strong> <br/>
                                    {props.groupInfo.groupMembers.length} submitted ({props.groupInfo.groupMembers.join(" ")})
                                    <div><button onClick={this.onDisplayGroupMovies}>View updated status</button></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    }else if (props.userInfo[props.username].lastWatchedMovie) {
        return (
            <div className='container'>
                <h1>Welcome to Movie Tinder!</h1>
                <div className='ui grid' id='poster'>
