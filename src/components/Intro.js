        ...
        return (
            <div className="ui grid">
                <div className='ui row'>
                    <div className='eight wide column' onClick={() => this.props.onViewingOptionSelect('singleViewing')}>
                        <button onClick={() => this.props.onViewingOptionSelect('singleViewing')}>Single Viewing</button>
                    ...
                    <div className='eight wide column' onClick={() => this.props.onViewingOptionSelect('group')}>
                        <button onClick={() => this.props.onViewingOptionSelect('group')}>Group Viewing</button>
