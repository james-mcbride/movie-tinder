    ...
    renderContent(){
        ...
        if (!this.state.preferences || this.state.returnHome){
            if (this.state.viewingChoice === 'single') {
                ...
                return <GroupSetup groupInfo={this.state.groupInfo}  userInfo={this.state.userInfo} tabSelect={this.onViewingOptionSelect} onGroupSetupSubmit={this.onGroupSetupSubmit} username={this.state.username} returnHome={this.onReturnHome} onRatedMovie={this.onRatedMovie}/>
            } else if (this.state.viewingChoice==='savedMovies'){
                return <MovieGenerator tabSelect={this.onViewingOptionSelect} userInfo={this.state.userInfo} username={this.state.username} movieType={'savedMovies'} allMovies={this.state.userInfo[this.state.username].savedMovies} returnHome={this.onReturnHome}  onRatedMovie={this.onRatedMovie} watchedMovies={this.state.userInfo[this.state.username].watchedMovies} serverMovies={this.state.serverMovies}/>
